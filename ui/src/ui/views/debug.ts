  ...
  return html`
    <section class="grid grid-cols-2">
      <div class="card">
        <div class="row" style="justify-content: space-between;">
          ...
          <button class="btn" ?disabled=${props.loading} @click=${props.onRefresh}>
            ${props.loading ? t("debug.snapshots.refreshing") : t("debug.snapshots.refreshButton")}
          </button>
        </div>
          ...
          <div>
            ...
            ${securitySummary
              ? html`<div class="callout ${securityTone}" style="margin-top: 8px;">
                  ${t("debug.snapshots.securityAudit")}: ${securityLabel}${info > 0 ? ` · ${info} ${t("debug.snapshots.info")}` : ""}. ${t("debug.snapshots.runDeep")}
                  <span class="mono">openclaw security audit --deep</span> ${t("debug.snapshots.forDetails")}.
                </div>`
              : nothing}
      ...
      <div class="card">
        ...
        <div class="form-grid" style="margin-top: 16px;">
          <label class="field">
            ...
            <input
              ...
              placeholder="${t("debug.rpc.methodPlaceholder")}"
            />
          </label>
          <label class="field">
        ...
        <div class="row" style="margin-top: 12px;">
          <button class="btn primary" @click=${props.onCall}>${t("debug.rpc.callButton")}</button>
        </div>
        ${props.callError
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      ${props.eventLog.length === 0
        ? html`<div class="muted" style="margin-top: 12px;">${t("debug.eventLog.noEvents")}</div>`
        : html`
