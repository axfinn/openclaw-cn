  ...
  return html`
    <div class="card">
      ...
      <div class="row" style="margin-top: 14px; flex-wrap: wrap;">
        ...
        >
          ${props.whatsappBusy ? t("channels.whatsapp.working") : t("channels.whatsapp.showQrButton")}
        </button>
        <button
          class="btn"
          ?disabled=${props.whatsappBusy}
        ...
        >
          ${t("channels.whatsapp.relinkButton")}
        </button>
        <button
          class="btn"
          ?disabled=${props.whatsappBusy}
        ...
        >
          ${t("channels.whatsapp.logoutButton")}
        </button>
        <button class="btn" @click=${() => props.onRefresh(true)}>
          ${t("channels.whatsapp.refreshButton")}
        </button>
      </div>
